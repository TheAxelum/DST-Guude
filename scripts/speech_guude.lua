...
return {
	ACTIONFAIL =
	{
		SHAVE =
		{
			...
			NOBITS = "Oh ya probably can't shave any more, hmmm!",
		},
		STORE =
		{
			GENERIC = "Damn chest is full.",
			NOTALLOWED = "Hmm, ok that can't go in there.",
			INUSE = "Jeez hurry up!",
		},
		RUMMAGE =
		{	
        ...
        COOK =
        {
            GENERIC = "That's not how you cook",
            INUSE = "Come on, come on hurry up!",
            TOOFAR = "Who put that way over there?",
        },
        GIVE =
        {
            DEAD = "Oh you’re dead, guess you won't be needing this huh?",
            SLEEPING = "Wake up! I got things to do",
            BUSY = "Why you no want?",
        },
        GIVETOPLAYER = 
        {
        	FULL = "I TRIED! YOUR INVENTORY IS FULL!",
            DEAD = "Hmm don’t need this now do you?",
            SLEEPING = "Really? You’re asleep now?",
            BUSY = "STOP! I'M TRYING TO GIVE YOU THIS!",
    	},
    	GIVEALLTOPLAYER = 
        {
        	FULL = "Empty your inventory! Use a backpack!",
            DEAD = "See this woudn’t happen if you didn’t keep dieing!",
            SLEEPING = "Always sleeping",
            BUSY = "Grrrrr Stand still I’m trying to give you this!",
    	},
        WRITE =
        {
            GENERIC = "I can't do that.",
            INUSE = "There's only room for one.",
        },
        CHANGEIN =
        {
            GENERIC = "I can't do that.",
        ...
        ATTUNE =
        {
            NOHEALTH = "It hurts! Why does it hurt?!",
        },
	},
	ACTIONFAIL_GENERIC = "Nope, not doing it.",
	ANNOUNCE_ADVENTUREFAIL = "Sigh, I'm never helping you all again",
	ANNOUNCE_BEES = "BEEEEEEEEEEEEES!!!!",
	ANNOUNCE_BOOMERANG = "Ahh! &#$!ing lag!",
	ANNOUNCE_CHARLIE = "What was that?!",
	ANNOUNCE_CHARLIE_ATTACK = "AHHHHH!",
	ANNOUNCE_COLD = "See this is why we need stones!",
	ANNOUNCE_HOT = "Oh god it's so hot, why is it so hot?",
	ANNOUNCE_CRAFTING_FAIL = "Dang it, where did I put the rest of the stuff I need?",
	ANNOUNCE_DEERCLOPS = "♫ It came in like a Deerclops... ♫",
	ANNOUNCE_DUSK = "Does someone have a fire going? Why didn't anyone make a fire?",
	ANNOUNCE_EAT =
	{
		GENERIC = "MMmmm that makes my tummy feel good!",
		PAINFUL = "I don't feel so good.",
		SPOILED = "Yuck! That was terrible!",
		STALE = "I think that was starting to turn.",
		INVALID = "Can you even eat that?",
		YUCKY = "I'm not putting that in my mouth. You can, I'm not",
	},
	ANNOUNCE_ENTER_DARK = "Why is it so dark? I don't like the dark, why is it dark?",
	ANNOUNCE_ENTER_LIGHT = "I nearly died!",
	ANNOUNCE_FREEDOM = "I'm free! I'm finally free!",
	ANNOUNCE_HIGHRESEARCH = "I r smart now!",
	ANNOUNCE_HOUNDS = "Is that Niko?",
	ANNOUNCE_WORMS = "What was that?",
	ANNOUNCE_HUNGRY = "I'm hungry enough to eat spider eyes!",
	ANNOUNCE_HUNT_BEAST_NEARBY = "Found 'em.",
	ANNOUNCE_HUNT_LOST_TRAIL = "Dangit, lost 'em.",
	ANNOUNCE_HUNT_LOST_TRAIL_SPRING = "The wet ground won't hold a footprint.",
	ANNOUNCE_INV_FULL = "I can't carry any more stuff!",
	ANNOUNCE_KNOCKEDOUT = "Ugh, I think I drank too much!",
    ...
    ANNOUNCE_NODANGERGIFT = "I ain't got no time for that!",
	ANNOUNCE_NODANGERSLEEP = "I ain't got no time for that!",
	ANNOUNCE_NODAYSLEEP = "It's too bright out.",
	ANNOUNCE_NODAYSLEEP_CAVE = "I'm not tired.",
	ANNOUNCE_NOHUNGERSLEEP = "I'm not going to sleep on an empty stomach!",
	ANNOUNCE_NOSLEEPONFIRE = "Sleeping in that seems like a bad idea.",
	ANNOUNCE_NODANGERSIESTA = "I ain't got no time for that!",
	...
	ANNOUNCE_SHELTER = "I hope there's no lightning... but I need to dry off!",
	ANNOUNCE_THORNS = "Ow! That was dumb of me.",
	ANNOUNCE_BURNT = "Yikes! That was hot!",
	ANNOUNCE_TORCH_OUT = "Oh no! My torch ran out!",
	ANNOUNCE_FAN_OUT = "My fan is gone with the wind.",
    ANNOUNCE_COMPASS_OUT = "It's broke.",
	ANNOUNCE_TRAP_WENT_OFF = "Oops.",
	ANNOUNCE_UNIMPLEMENTED = "OW! I don't think it's ready yet.",
	ANNOUNCE_WORMHOLE = "I really don't want to think about that.",
	ANNOUNCE_CANFIX = "\nI think I can fix this!",
	ANNOUNCE_ACCOMPLISHMENT = "I feel so accomplished!",
	ANNOUNCE_ACCOMPLISHMENT_DONE = "If only my friends could see me now...",	
	ANNOUNCE_INSUFFICIENTFERTILIZER = "Need more poop here!",
	ANNOUNCE_TOOL_SLIP = "Whoops!",
	ANNOUNCE_LIGHTNING_DAMAGE_AVOIDED = "OH GOD THAT WAS CLOSE!",

	ANNOUNCE_DAMP = "Oh, I’m wet... hehehehehe.",
	ANNOUNCE_WET = "I’m getting wetter!.",
	...
	BATTLECRY =
	{
		...
		PIG = "Here Bacon, Bacon!",
		PREY = "I will destroy you!",
		SPIDER = "Spiders, why spiders?!",
	...
	DESCRIBE =
	{
		...
		BERRIES = "Nnnnuuuoooo Don’t eat the berries!.",
		...
		BIRDCAGE =
		{
			...
			SLEEPING = "Awwww, he's asleep. You sleepy little guy?",
